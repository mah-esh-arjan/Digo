        ...
        <div className="max-w-4xl mx-auto">
          <FadeIn className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Access and download our latest reports, project details, and corporate documents.
            </p>
          </FadeIn>
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="flex items-center justify-between p-6 bg-gray-50 rounded-3xl border border-gray-100 group hover:bg-navy hover:shadow-2xl transition-all duration-300">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <h3 className="font-bold text-navy text-xl group-hover:text-white transition-colors">{doc.name}</h3>
                      <div className="flex items-center gap-3 mt-1">
                        <span className="text-xs font-bold text-primary uppercase group-hover:text-primary-light">{doc.type}</span>
                        <div className="w-1 h-1 rounded-full bg-gray-300 group-hover:bg-gray-500" />
                        <span className="text-sm text-gray-400 group-hover:text-gray-300">{doc.size}</span>
                      </div>
                    </div>
                  </div>
                  
                  <button className="flex items-center gap-2 bg-white text-navy font-bold px-6 py-3 rounded-xl shadow-sm hover:bg-primary hover:text-white transition-all transform hover:-translate-x-2">
                    <Download size={20} />
