    ...
    <section className="py-32 bg-white relative overflow-hidden">
      <Container className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <FadeIn className="order-1 lg:order-2">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-surface shadow-sm border border-gray-100 text-primary font-semibold text-sm mb-6 uppercase tracking-widest">
            About Us
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-navy mb-8 tracking-tight leading-tight">
            15+ Years Experience In <br />
            <span className="text-primary italic">Hydro Energy Industry</span>
          </h2>

          <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
            <p>
              Digo Urja Bikas Company PVT. LTD was established in 2021 with the
              main aim of developing hydropower projects and generating
              electricity in various parts of the country.
            </p>
            <p>
              The company is formed by the effort of highly dedicated and
              qualified personnel who have sound and in-depth knowledge in
              identifying and selecting hydropower projects for further
              development.
            </p>

            <ul className="space-y-4 pt-4">
              {[
                "Clean and reliable hydropower energy company",
                "Innovative development strategy with local focus",
                "Committed to maximum energy efficiency",
                "Strong financial and technical leadership",
              ].map((text, i) => (
                <li
                  key={i}
