      ...
      <div className="flex w-[200%] gap-12 md:gap-24 overflow-hidden mt-8">
        ...
        >
          {logos.concat(logos).map((logo, i) => (
            <div 
              key={i} 
              className="group flex items-center justify-center grayscale hover:grayscale-0 opacity-40 hover:opacity-100 transition-all duration-300 cursor-default"
            >
              <div className="text-2xl font-extrabold text-navy tracking-tighter group-hover:text-primary transition-colors duration-300 relative inline-flex">
                 {logo}
